...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"> 
            ...
            <div class="panel-heading"><center><h5><strong>OFERTAS POR APROBAR</strong></h5></center></div> 
 <!--
...
Sistema de Admisión del @foreach($users as $user) {{$user->NombSede}} </th> 
 ...
 @endif-->
  ...
  {{ Form::open(['route' => 'ofertas.consultaAprobacion', 'method' => 'GET', 'class' => 'form-inline pull-right']) }}
                          
   <div class="form-group">
 {{ Form::text('NombInstituto', null, ['class' => 'form-control', 'placeholder' => 'Instituto/ Extensión']) }}
 </div>
              <div class="form-group">
...
<form name="formulario" class="form-groub" method="POST" action="{{ route('ofertas.aprobar') }}">
{{Form::token()}} 
<table class="table">
     ...
     <input type="checkbox" id="chec" onclick="marcar(this); btTutorial.disabled = !this.checked"/> Marcar/Desmarcar Todos
      ...
      <td colspan="5">
<button  class="btn btn-success btn-sm Active info button pull-right" onclick="return confirm('Seguro de que desea Aprobar la Oferta??')" name="btTutorial" disabled>Aprobar</button>
</td>
