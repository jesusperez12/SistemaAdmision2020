{!!Form:: open(array('url'=>'Academico', 'method'=>'POST', 'autocomplete'=> 'off')) !!}
	{{Form::token()}}
...
<section class="content">
 ...
 <div class="box-body">
         ...
         {{ Form::select('DependenciaPlantel', array('Pública' => 'Pública', 'Privada' => 'Privada'), null, ['class'=>'form-control','placeholder' => '--Seleccione--']) }}
          ...
          @if ($errors->has('TurnoEstudio'))
            ...
            <div class="form-group{{ $errors->has('Estados_id') ? ' has-error' : '' }}">
                  ...
                  {{ Form::select('Estados_id', $estado, null, ['class'=>'form-control','id'=>'estado', 'placeholder' => '--Seleccione--']) }}
      ...
      <div class="form-group{{ $errors->has('Municipio_id') ? ' has-error' : '' }}">
                  ...
                  {{ Form::select('Municipio_id', array(), null, ['class'=>'form-control','id'=>'Muni', 'placeholder' => 'Seleccione.']) }}
