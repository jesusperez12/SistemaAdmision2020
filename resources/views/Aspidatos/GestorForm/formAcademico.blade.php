...
{!!Form:: open(array('url'=>'DatosAcademicos', 'method'=>'POST', 'autocomplete'=> 'off')) !!}
	{{Form::token()}}
 ...
 <div class="box-body">
	     ...
	     <div class="input-group">
                  <input type="text" class="form-control datepicker"  id="fechaini" name="FechaInicio" placeholder="Dia/mes/año">
              ...
              <div class="form-group{{ $errors->has('fechaCulminacion') ? ' has-error' : '' }}">
				...
				{!! Form::label('fechaCulminacion', 'Fecha de Culminación')!!}
				  <div class="input-group">
                  <input type="text" class="form-control datepicker" id="fechaculmi" name="fechaCulminacion" placeholder="Dia/mes/año">
                  <div class="input-group-addon">
                 <span class="glyphicon glyphicon-th"></span>
                  </div>
                </div> 
        ...
        {!! Form::label('FechaGrado', 'Fecha de Grado')!!}
         <div class="input-group">
                  <input type="text" class="form-control datepicker" id="fechagrado" name="FechaGrado" placeholder="Dia/mes/año">
                  <div class="input-group-addon">
                 <span class="glyphicon glyphicon-th"></span>
                  </div>
                </div> 
...
<script type ="text/javascript">
  ...
  $('#fechaini').mask('00/00/0000');
  $('#fechaculmi').mask('00/00/0000');
   $('#fechagrado').mask('00/00/0000');
