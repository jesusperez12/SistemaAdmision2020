...
<div id="main">
  ...
  <div class="box box-primary">
        ...
        <div class="box-body">
          ...
          {!! Form::text('PrimerNombre', $name,  ['class'=> 'form-control', 'id' => 'name','placeholder'=>'']) !!}  
     ...
     {!!Form::label('Pais_id','País de Origen:')!!}
            ...
            {{ Form::select('Estados_id', $estado, null, ['class'=>'form-control','id'=>'estado', 'placeholder' => 'Seleccione una Opción...']) }}
             ...
             {!!Form::label('Municipio:')!!}
              ...
              {{ Form::select('Municipios_id', array(), null, ['class'=>'form-control','id'=>'Muni', 'placeholder' => 'Seleccione una Opción...']) }}
              ...
              {{ Form::select('Parroquias_id', array(), null, ['class'=>'form-control','id'=>'parroquia', 'placeholder' => 'Seleccione una Opción...']) }}
 ...
 <div class="box box-primary">
    ...
    <div class="form-group {{ $errors->has('FechaNacimiento') ? ' has-error' : '' }}">       
          ...
          <div class="input-group">
                  <input type="text" class="form-control datepicker" name="FechaNacimiento" placeholder="DIA/MES/AÑOS" id="Fec_Nac">
...
<div class="form-group{{ $errors->has('TelefonoLocal') ? ' has-error' : '' }}">
  ...
  {!! Form::label('Correo', 'Correo Electrónico:')!!}
    <input type="text" class="form-control datepicker" name="Correo"  value="{{$idemail}}" >
